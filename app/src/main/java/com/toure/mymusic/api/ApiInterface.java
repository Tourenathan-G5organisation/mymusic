...
public interface ApiInterface {
    ...
    @GET("?method=artist.gettopalbums&format=json&limit=50")
    Call<AlbumQuery> getArtistBestAlbum(@Query("artist") String artistName, @Query("api_key") String apiKey, @Query("page") int page);
